...
export const METHODOLOGY: readonly MethodTopic[] = [
  ...
  },
  {
    ...
    formula: 'A = run ÷ (run + recharge)   |   A = charge ÷ (charge + draw)        fleet = ⌈ demand ÷ A ⌉',
    variables: [
      ...
      { sym: 'draw', name: 'Operating draw', def: 'Current the vehicle pulls while working.', unit: 'A' },
      { sym: 'charge', name: 'Charge rate', def: 'Current the charger supplies.', unit: 'A' },
      { sym: 'A', name: 'Availability', def: 'Share of the clock a vehicle can work (the rest is charging), 0–1.', unit: '0–1' },
    ],
    why: 'A vehicle on the charger is not moving loads. Availability is the fraction of wall-clock time it can work; dividing demand by it provisions enough vehicles that the line never starves while others recharge. Plugged charging interleaves run and recharge; opportunity charging tops up continuously. If an overnight charge fully recovers the battery between shifts, charging steals no operating time and adds nothing.',
  },
  {
    id: 'buffer',
    num: '04',
