...
/** Per-type runtime, recharge, and uptime (availability). */
export default function ChargingSummary({ series }: Props) {
  ...
  return (
    <table className="rv-charge">
      <thead><tr><th>Vehicle</th><th className="num">Runtime</th><th className="num">Recharge</th><th className="num">Uptime</th></tr></thead>
      <tbody>
        {series.rows.map(r => (
