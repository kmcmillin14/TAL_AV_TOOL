...
const TIER_PROJECT = 'Your project'
const TIER_APPLICATION = 'Your application'
...
const SECTIONS: readonly QSection[] = [
  { id: 'q-sec-01', num: '01', short: 'Company', tier: TIER_PROJECT,
    fields: ['customerName', 'facilityLocation', 'customerContactName', 'customerContactRole', 'customerContactEmail', 'customerContactPhone', 'talRepName', 'talRepEmail', 'talRepPhone', 'oemDealer', 'dealershipName', 'dealerRep'] },
  { id: 'q-sec-02', num: '02', short: 'Opportunity', tier: TIER_PROJECT,
    fields: ['projectName', 'projectStage', 'isRfq', 'rfqNumber', 'rfqDueDate', 'budgetStatus', 'budgetRange', 'decisionDate', 'targetGoLiveDate', 'cadAvailable', 'cadNotes'] },
  { id: 'q-sec-03', num: '03', short: 'Why & today', tier: TIER_PROJECT,
    fields: ['projectDrivers', 'currentProcess', 'existingAutomation', 'volumeGrowthNote', 'seasonalityNote'] },
  { id: 'q-sec-04', num: '04', short: 'What you move', tier: TIER_APPLICATION,
    fields: ['typicalUnitType', 'otherUnitTypeDescription', 'maxLoadWeightLbs', 'loadLengthIn', 'loadWidthIn', 'loadHeightIn'] },
  { id: 'q-sec-05', num: '05', short: 'Handling', tier: TIER_APPLICATION,
    fields: ['pickContext', 'dropContext', 'transferType', 'transferHeightFt'] },
  { id: 'q-sec-06', num: '06', short: 'Environment', tier: TIER_APPLICATION,
    fields: ['minAisleWidthFt', 'floorCondition', 'outdoorRequired', 'temperatureEnvironment', 'tempMinF', 'tempMaxF', 'dustMoisture'] },
  { id: 'q-sec-07', num: '07', short: 'Site readiness', tier: TIER_APPLICATION,
    fields: ['facilitySizeSqFt', 'dockDoors', 'networkReady', 'itContact', 'siteWalkthroughAvailable'] },
  { id: 'q-sec-08', num: '08', short: 'Schedule', tier: TIER_APPLICATION,
    fields: ['shiftsPerDay', 'hoursPerShift', 'operatingDaysPattern', 'breaksPerShift', 'breakDurationMin'] },
  { id: 'q-sec-09', num: '09', short: 'Throughput', tier: TIER_APPLICATION,
    fields: ['requiredThroughputPerHour', 'peakThroughputPerHour', 'avgDistanceFt', 'distanceType'] },
  { id: 'q-sec-10', num: '10', short: 'Interested in', tier: TIER_APPLICATION,
    fields: ['specialtyApplications', 'vehiclesOfInterest', 'vehicleInMind'] },
  { id: 'q-sec-11', num: '11', short: 'Certs & controls', tier: TIER_APPLICATION,
    fields: ['certifications', 'interlocks', 'wmsRequired', 'wmsVendor'] },
  { id: 'q-sec-12', num: '12', short: 'Anything else', tier: TIER_APPLICATION,
    fields: ['projectNotes'] },
]
    ...
    <form className="workspace" onSubmit={handleSubmit(onSubmit, onInvalid)}>
      ...
      <div className="form-with-nav q-page-nav">
        ...
        <div className="form-stack">
          <FormSection id="q-sec-01" sectionNum="01" title="Your company & contact">
          ...
          <FormSection id="q-sec-02" sectionNum="02" title="The opportunity">
            <div className="fld-grid-3">
          ...
          <FormSection id="q-sec-03" sectionNum="03" title="Why & how it’s done today">
          ...
          <FormSection id="q-sec-04" sectionNum="04" title="What you move">
            <div className="fld-grid-4">
              <div className="fld">
          ...
          <FormSection id="q-sec-05" sectionNum="05" title="How loads are picked up & set down">
            <div className="fld-grid-2">
              <div className="fld">
          ...
          <FormSection id="q-sec-06" sectionNum="06" title="Environment">
            <div className="fld-grid-3">
              <div className="fld">
          ...
          <FormSection id="q-sec-07" sectionNum="07" title="Site readiness">
            <div className="fld-grid-3">
          ...
          <FormSection id="q-sec-09" sectionNum="09" title="Throughput">
            <div className="fld-grid-4">
          ...
          <FormSection id="q-sec-10" sectionNum="10" title="What you’re interested in">
            <div className="fld-grid-4">
              <div className="fld span-4">
              ...
              <div className="fld span-4">
                <label>Vehicles that catch your eye</label>
          ...
          <FormSection id="q-sec-11" sectionNum="11" title="Certifications & controls">
            <div className="fld-grid-4">
